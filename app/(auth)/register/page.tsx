...
export default function RegisterPage() {
  return (
    <section className="grid min-h-[80dvh] bg-ticket lg:grid-cols-[1fr_1.15fr]">
      <div className="hero-grid flex items-center border-b border-primary-foreground/15 bg-primary px-6 py-16 text-primary-foreground sm:px-10 lg:border-b-0 lg:border-r lg:border-r-edge">
